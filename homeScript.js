  ...
  document.querySelector(".cardContainer").querySelectorAll(".card").forEach(card => {
    card.addEventListener("click", () => {
      console.log("THE CARD IS CLICKED");
        ...
        console.log(`http://127.0.0.1:3000/Spotify/songs/${encodeURIComponent(card.querySelector(".title").innerHTML)}.mp3`);
        
        playMusic(`http://127.0.0.1:3000/Spotify/songs/${encodeURIComponent(card.querySelector(".title").innerHTML)}.mp3`, true);
